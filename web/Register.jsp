			...
			<%
				...
				if (submitted != null) {
					...
					if (!fName.matches(nameReg)) {
						...
						valid = false;
					} else if (!pwd.matches(usernamePasswordReg) || pwd.length() < 6) {
						...
						out.println(pwd);
						out.println(cPwd);
						out.println(confirmPasswordMessage);
						valid = false;
					} 
					...
					if (!valid) {
						out.println("<form class='pure-form pure-form-stacked' action='Register.jsp' method='post'>");
							out.println("<fieldset>");
								...
								out.println("<span id='firstNameMessage' class='firstNameMessage'>"+fNameMessage+"</span></center>");
								...
								out.println("<span id='lastNameMessage' class='lastNameMessage'>"+lNameMessage+"</span></center>");
								...
								out.println("<span id='mobileMessage' class='mobileMessage'>"+mobileMessage+"</span></center>");
								...
								out.println("<span id='alternateMobileMessage' class='alternateMobileMessage'>"+alternateMessage+"</span></center>");
								...
								out.println("<span id='emailMessage' class='emailMessage'>"+emailMessage+"</span></center>");
								...
								out.println("<span id='usernameMessage' class='usernameMessage'>"+usernameMessage+"</span></center>");
								...
								out.println("<span id='passwordMessage' class='passwordMessage'>"+passwordMessage+"</span></center>");
								...
								out.println("<span id='confirmPasswordMessage' class='confirmPasswordMessage'>"+confirmPasswordMessage+"</span><center>");
